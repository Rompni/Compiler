...
_lr_productions = [
  ...
  ('body -> LBRACE all_sentences RBRACE','body',3,'p_body','parser.py',15),
  ('all_sentences -> all_sentences list_sentences','all_sentences',2,'p_all_sentences','parser.py',19),
  ('all_sentences -> sentence','all_sentences',1,'p_all_sentences','parser.py',20),
  ('list_sentences -> sentence','list_sentences',1,'p_list_sentences','parser.py',24),
  ('sentence -> declaration','sentence',1,'p_sentence','parser.py',28),
  ('sentence -> function_dec','sentence',1,'p_sentence','parser.py',29),
  ('sentence -> assign','sentence',1,'p_sentence','parser.py',30),
  ('sentence -> empty','sentence',1,'p_sentence','parser.py',31),
  ('declaration -> IDTYPE ID SEMI','declaration',3,'p_declaration','parser.py',35),
  ('boolean -> TRUE','boolean',1,'p_booleans','parser.py',39),
  ('boolean -> FALSE','boolean',1,'p_booleans','parser.py',40),
  ('operator -> LOR','operator',1,'p_operators','parser.py',44),
  ('operator -> LAND','operator',1,'p_operators','parser.py',45),
  ('operator -> LNOT','operator',1,'p_operators','parser.py',46),
  ('operator -> LT','operator',1,'p_operators','parser.py',47),
  ('operator -> GT','operator',1,'p_operators','parser.py',48),
  ('operator -> LE','operator',1,'p_operators','parser.py',49),
  ('operator -> GE','operator',1,'p_operators','parser.py',50),
  ('operator -> EQ','operator',1,'p_operators','parser.py',51),
  ('operator -> NE','operator',1,'p_operators','parser.py',52),
  ('print -> PRINT tvariable SEMI','print',3,'p_print_statement','parser.py',56),
  ('print -> PRINT ID SEMI','print',3,'p_print_statement','parser.py',57),
